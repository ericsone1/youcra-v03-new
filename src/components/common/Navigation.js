  ...
  return (
    <footer className="fixed bottom-0 left-0 w-full bg-white rounded-t-2xl shadow-lg border-t flex justify-around items-center h-16 z-50">
      ...
      <Link
        to="/chat"
        className={`flex flex-col items-center ${
          isActive('/chat') ? 'text-blue-500 font-bold' : 'text-gray-400'
        }`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M17 8h2a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2v-8a2 2 0 012-2h2m10 0V6a4 4 0 00-8 0v2"
          />
        </svg>
      ...
      <Link
        to="/report"
        className={`flex flex-col items-center ${
          isActive('/report') ? 'text-blue-500 font-bold' : 'text-gray-400'
        }`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <Link
        to="/my"
        className={`flex flex-col items-center ${
          isActive('/my') ? 'text-blue-500 font-bold' : 'text-gray-400'
        }`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
